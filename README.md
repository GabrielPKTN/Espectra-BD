...
2. git pull
3. git switch -c feature/tabelas

4. Realize as alterações necessárias
5. git add .
6. git commit -m "feat: Adiciona tabelas do banco de dados"
7. git push -u origin feature/tabelas
8. Abra o GitHub → New Pull Request
   base: develop ← compare: feature/tabelas
